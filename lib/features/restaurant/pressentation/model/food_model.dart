class FoodModel {
  ...
  static List<FoodModel> menu = [
    FoodModel('assets/images/food/img_food.jpg', 'kjjdf,sdfsdnfbmnsbdfmbsmdbfbsmdnfbsdmnbfmndsbfnmbsdmnfbsdbmf bfmsdbfmbsnd   dmsbmf sdf dsfbbdnmfbs m bmfdbsmfm', '20\$'),
